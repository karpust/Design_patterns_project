...
class RoundableSquare(Square, Roundable):
    """
    это класс-адаптер
    Square – класс, который нужно привести к новому интерфейсу. Адаптируемый класс.
    Roundable – интерфейс, к которому мы хотим привести наш класс Square.
    """
    def get_radius(self):
