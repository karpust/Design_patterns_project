...
«Отслеживает изменения данных в доменной модели 
в рамках бизнес-транзакции»
«После закрытия бизнес-транзакции все изменения 
модели попадают в БД в виде единой транзакции»
"""
